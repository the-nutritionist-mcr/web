                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <h1 class="null" style="text-align: left;"><span style="font-size:26px"><strong>
                                            <font face="playfair display, georgia, times new roman, serif"><span
                                                style="font-family:arial,helvetica neue,helvetica,sans-serif">Welcome to
                                                your personal Members Area</span></font>
                                          </strong></span></h1>
                                                            ...
                                                            <td valign="top">
                                                              ...
                                                              <p>
                                                                <font
                                                                  ...
                                                                  You'll now be able to login, view&nbsp;your&nbsp;fresh
                                                                  weekly menu, and choose exactly what you receive in
                                                                  your two fresh deliveries.</font>
                                                              </p>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <span style="font-size:24px"><span
                                          style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><strong>Logging
                                            In</strong></span></span>
                                    </td>
                                  </tr>
                                </tbody>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <ul>
                                        <li><span
                                            style="font-family:playfair display,georgia,times new roman,serif">Click <a
                                              href="https://app.thenutritionistmcr.com/login" target="_blank">here</a>
                                            to visit your&nbsp;members area of thenutritionistmcr.com</span></li>
                                        <li><span
                                            style="font-family:playfair display,georgia,times new roman,serif">Enter the
                                            password: <strong>${password}</strong>and hit&nbsp;login</span></li>
                                        <li><span style="font-family:playfair display,georgia,times new roman,serif">On
                                            your first time logging in, you'll be prompted to change the password to
                                            something more memorable for you</span></li>
                                      </ul>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <span style="font-size:24px"><span
                                          style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><strong>How
                                            it Works</strong></span></span>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" class="mcnTextContent"
                                      ...
                                      <ul>
                                        <li>
                                          <font face="playfair display, georgia, times new roman, serif"><strong>Monday
                                              12pm midday - </strong>Your fresh new menus are live and ready for you to
                                            choose your meals for the following week.</font>
                                        </li>
                                        <li><span
                                            style="font-family:playfair display,georgia,times new roman,serif"><strong>Wednesday
                                              12pm&nbsp;midday - </strong>The deadline for having your meal&nbsp;choices
                                            in! Didn't have time to choose? Don't worry, we'll prepare your nutritionist
                                            recommended mix of meals, based on your personal food
                                            preferences.&nbsp;</span></li>
                                        <li>
                                          <font face="playfair display, georgia, times new roman, serif">
                                            Meals&nbsp;include&nbsp;ingredients you don't like? Don't worry, go ahead
                                            and order. We'll apply your personal food preferences to all of your
                                            meals&nbsp;once your order arrives with us.</font>
                                        </li>
                                      </ul>
